...
const translations = reactive({
  en: {
    ...
    commandPlaceholder: 'e.g. uptime, df -h, free -m',
    commandTimeout: 'Timeout (s)',
    commandSent: 'Command sent to server',
    ...
    cancelCommands: 'Cancel Pending',
    noCommands: 'No commands executed yet',
    execute: 'Execute',
    cmdTip: 'Type a shell command to execute on the target server. Output will be shown here once executed.',
    cmdError: 'Failed to send command',
    cmdRefresh: 'Refresh Results',
    commandSentAt: 'Sent at',
    commandRanAt: 'Started at',
    commandDoneAt: 'Completed at',
  },
  zh: {
    theme: '主题',
    themeAuto: '自动',
    ...
    cmdFailed: '失败',
    cmdCancelled: '已取消',
    cancelCommands: '取消待执行',
    noCommands: '暂无执行记录',
    execute: '执行',
    cmdTip: '输入要在目标服务器上执行的 Shell 命令，执行结果将显示在这里。',
    cmdError: '命令发送失败',
    cmdRefresh: '刷新结果',
    commandSentAt: '发送时间',
    commandRanAt: '开始时间',
